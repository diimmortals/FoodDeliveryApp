...
private extension AppCoordinator {
    ...
    func showMainFlow(){
        ...
        let homeCoordinator = HomeCoordintaor(type: .home, navigationController: homeNavigationController)
        ...
        let orderCoordinator = OrderCoordintaor(type: .order, navigationController: orderNavigationController)
        ...
        let listCoordinator = ListCoordintaor(type: .list, navigationController: listNavigationController)
        ...
        let profileCoordinator = ProfileCoordintaor(type: .profile, navigationController: profileNavigationController)
